    ...
    <template v-if="step === 'search'">
      <q-card-section class="q-pb-xs">
        <q-input v-model="query" outlined dense autofocus
          ...
          <template #append><q-spinner v-if="loading" color="blue-grey" size="18px" /></template>
        </q-input>
      </q-card-section>
      ...
      <q-card-section class="q-pb-sm">
        ...
        <div class="row q-col-gutter-sm">
          ...
          <q-select v-model="cfg.unit" :options="unitOpts" emit-value map-options
            label="Unidade" outlined dense dark options-dark class="col-12 col-sm-3" />
          ...
          <q-input v-if="cfg.use === 'Boil' || cfg.use === 'Mash'"
            ...
            label="Tempo" suffix="min" outlined dense dark class="col-12 col-sm-3" />
        </div>
      </q-card-section>
      <q-separator dark />
